...
const CuteAbout3D = () => {
  ...
  return <motion.section ref={containerRef} style={{
    opacity
  }} id="about" className="relative py-20 bg-gradient-to-br from-background via-primary/5 to-secondary/5 overflow-hidden">
      {/* Cute floating elements */}
      <div className="absolute inset-0 opacity-30">
        {Array.from({
        length: 12
      }).map((_, i) => <motion.div key={i} className="absolute" style={{
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          once: true
            ...
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10 rounded-full px-8 py-4 mb-8 border border-primary/20 shadow-lg">
              ...
              <span className="text-primary font-bold text-xl">Raksha Hostels</span>
          ...
          once: true
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-accent mb-6 leading-tight">Itself reflects security</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          {/* Text Content */}
          <motion.div className="space-y-6" style={{
          y
        }}>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => <div key={index} className="sc-ring rounded-3xl overflow-hidden">
        ...
        once: true
          ...
          }].map((item, index) => <motion.div key={index} className="group relative" initial={{
            opacity: 0,
            y: 50
          }} whileInView={{
            opacity: 1,
        ...
        {/* Stats Section */}
        <motion.div className="grid grid-cols-2 lg:grid-cols-4 gap-6" initial={{
        opacity: 0,
        y: 30
      }} whileInView={{
        opacity: 1,
