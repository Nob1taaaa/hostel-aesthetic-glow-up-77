      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          <div className="order-2 lg:order-1">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-6 lg:mb-8 px-2">Get in Touch</h3>
            
            <div className="grid sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
                ...
                >
                  <CardContent className="p-3 sm:p-4 lg:p-6">
                    <div className="flex items-start gap-3 sm:gap-4">
                      <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-teal-100 rounded-lg flex items-center justify-center text-teal-600">
                        {info.icon}
                      </div>
                      <div className="min-w-0 flex-1">
                        <h4 className="font-semibold text-gray-800 mb-1 text-sm sm:text-base">{info.title}</h4>
                        <p className="text-xs sm:text-sm text-gray-600 whitespace-pre-line leading-relaxed">{info.details}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div 
              className="aspect-w-16 aspect-h-9 rounded-xl sm:rounded-2xl overflow-hidden shadow-lg cursor-pointer"
                ...
                <form className="space-y-4 sm:space-y-6">
                  <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                    <div>
                      ...
                      <Input placeholder="Your full name" className="border-gray-300 text-sm" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Phone</label>
                      <Input placeholder="Your phone number" className="border-gray-300 text-sm" />
                    </div>
                  </div>
                  
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Email</label>
                    <Input type="email" placeholder="Your email address" className="border-gray-300 text-sm" />
                  </div>
                  
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Subject</label>
                    <Input placeholder="Subject of your message" className="border-gray-300 text-sm" />
                  </div>
                  ...
                  <Button className="w-full bg-gradient-to-r from-teal-600 to-orange-500 hover:from-teal-700 hover:to-orange-600 text-white text-sm sm:text-base lg:text-lg py-2 sm:py-3">
                    Send Message
                  </Button>
                </form>
              </CardContent>
