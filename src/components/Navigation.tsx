        ...
        <div className="flex justify-between items-center h-14 sm:h-16">
          <div className="flex items-center min-w-0">
            <div className="flex-shrink-0">
              <div className="flex items-center space-x-2 sm:space-x-3">
                {/* Hostel Logo */}
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 relative group flex-shrink-0">
                  <img 
                ...
                <div className="flex flex-col min-w-0">
                  <span className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-gray-800 dark:text-white transition-colors duration-300 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-teal-600 group-hover:to-orange-500 truncate">
                    RAKSHA HOSTEL
                  </span>
                  <span className="text-xs sm:text-sm text-gray-500 italic hidden sm:block">itself reflects security</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="md:hidden flex items-center space-x-2 flex-shrink-0">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="w-7 h-7 rounded-full p-0 border-gray-300 dark:border-slate-600 flex-shrink-0"
            >
              {theme === "light" ? (
            ...
            <button
              ...
              className="text-gray-700 dark:text-gray-300 hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-200 flex-shrink-0"
            >
